...
def _hparams(cfg):
    ...
    _hparam('mi', cfg.mi, lambda r: cfg.mi)
    _hparam('weight_mi', cfg.weight_mi, lambda r: cfg.weight_mi)
    _hparam('weight_kl', cfg.weight_kl, lambda r: cfg.weight_kl)
    _hparam('weight_cls', cfg.weight_cls, lambda r: cfg.weight_cls)
