...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='MISTS Experiments')
    # Data parameters
    ...
    parser.add_argument('--mi', action='store_true', default=False,
                        help='Whether to use mutual information terms')
    parser.add_argument('--weight_mi', default=1, type=float)
    parser.add_argument('--weight_kl', default=1, type=float)
    parser.add_argument('--weight_cls', default=1, type=float)
